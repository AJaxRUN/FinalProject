...
void markerTimerCallback(const ros::TimerEvent&)
{
  ...
  static ros::Publisher marker_pub = n.advertise<visualization_msgs::Marker>("visualization_marker", 1);
...
int main(int argc, char **argv)
{
  ...
  // Create a timer to call markerCallback every second
  ros::Timer timer = n.createTimer(ros::Duration(1.0), markerTimerCallback);
